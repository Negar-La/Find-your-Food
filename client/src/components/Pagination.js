...
const Pagination = props => {
    //props from HomePage, go there to see more
    const {
        currentPage, // current page
        setCurrentPage, // set current page
        posts, // searchedItems being paginated
    } = props;
 
    const limit = 12; // PAGINATION LIMIT OF ITEMS PER PAGE. 
    let pages = posts?.length/limit; // number of pages is total # of searchedItems/limit
